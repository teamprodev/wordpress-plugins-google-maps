                    ...
                    <div class="elfsight-admin-page-activation-faq-list-item-answer">
                        <?php
                            printf(
                                ...
                                esc_html__('Activating the %1$s will give you access to the automatic plugin updates. Now bug fixes and new features will be automatically implemented in your plugin.', $this->textDomain),
                                sprintf(
